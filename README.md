...
For this exercise, please add an HTML table row in the `teams-spring2022/index.html` web page by following the same format.
...
And our class page is at: `http://cs480-projects.github.io/teams-spring2022/index.html`

Exercise 2 - Add Your Team Page
===============================

Each team should add a simple team page in `teams-spring2022/` folder and link it from the `teams-spring2022/index.html` page.
...
Again, our class page is at: `http://cs480-projects.github.io/teams-spring2022/index.html`
