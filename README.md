...
For this exercise, please add an HTML table row in the `teams-fall2021/index.html` web page by following the same format.
...
And our class page is at: `http://cs480-projects.github.io/teams-fall2021/index.html`

Exercise 2 - Add Your Team Page
===============================

Each team should add a simple team page in `teams-fall2021/` folder and link it from the `teams-fall2021/index.html` page.
...
Again, our class page is at: `http://cs480-projects.github.io/teams-fall2021/index.html`
